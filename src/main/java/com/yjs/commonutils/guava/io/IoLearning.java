package com.yjs.commonutils.guava.io;
...
public class IoLearning {
    private static File testFile = new File("src/main/java/yjs/test.txt");
    private static File newFile = new File("src/main/java/yjs/new.txt");
